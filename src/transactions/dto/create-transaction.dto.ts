...
export class CreateTransactionDto {
  ...
  @ValidateNested() // valida que los campos de TransactionContentsDto tambien sean validados
  @Type(() => TransactionContentsDto) // transform cada elemento del array a una clase dto mencionada
